...
C_SRCS += \
../libs/joystick/joystick.c 

OBJS += \
./libs/joystick/joystick.o 

C_DEPS += \
./libs/joystick/joystick.d 


# Each subdirectory must supply rules for building sources it contributes
libs/joystick/%.o libs/joystick/%.su libs/joystick/%.cyclo: ../libs/joystick/%.c libs/joystick/subdir.mk
...
clean: clean-libs-2f-joystick

clean-libs-2f-joystick:
	-$(RM) ./libs/joystick/joystick.cyclo ./libs/joystick/joystick.d ./libs/joystick/joystick.o ./libs/joystick/joystick.su

.PHONY: clean-libs-2f-joystick
